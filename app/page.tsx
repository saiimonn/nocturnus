    ...
    <div className="flex flex-col flex-1 bg-linear-to-b from-black to-[#202020] text-white">
      <div className = "flex justify-between items-center p-16">
        ...
        <div className = "flex gap-4 items-center">
          ...
          <div className = "rounded-2xl px-4 py-2 bg-white text-black">
            Profile
          </div>
        </div>
      </div>
      ...
      <div className = "flex flex-col flex-1 items-center justify-center px-6 -mt-24">
        ...
        <p className = "text-xs md:text-sm text-[#a3a3a3] mb-10 text-center">
          Lorem Ipsum has been the industrys standard dummy text ever since the 1500s
        </p>

        <div className = "relative w-full max-w-2xl items-center">
