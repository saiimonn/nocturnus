  ...
  return (
    <div className="w-full bg-white/5 rounded-lg overflow-hidden border border-white/10">
      ...
      <div className="p-4">
        ...
        {/* Wrap the button in a dynamic link using the event's id */}
        <Link href={`/events/${event.id}`}>
          <button className="w-full border border-white/20 rounded py-2 text-xs font-semibold hover:bg-white hover:text-black transition cursor-pointer">
            VIEW DETAILS
          </button>
        </Link>
